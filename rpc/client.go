...
func (c *Client) SupportedModules() (map[string]string, error) {
	...
	defer cancel()
	err := c.CallArrayContext(ctx, &result, "rpc_modules")
	return result, err
}
...
func (c *Client) Call(result interface{}, method string, args ...interface{}) error {
	...
	return c.CallArrayContext(ctx, result, method, args)
}
...
// The result must be a pointer so that package json can unmarshal into it. You
// can also pass nil, in which case the result is ignored.
func (c *Client) CallArrayContext(ctx context.Context, result interface{}, method string, args ...interface{}) error {
	msg, err := c.newArrayMessage(method, args...)
	if err != nil {
		return err
	}
	return c.callContext(ctx, result, method, msg)
}

func (c *Client) CallObjectContext(ctx context.Context, result interface{}, method string, args interface{}) error {
	msg, err := c.newObjectMessage(method, args)
	if err != nil {
		return err
	}
	return c.callContext(ctx, result, method, msg)
...
func (c *Client) callContext(ctx context.Context, result interface{}, method string, msg *jsonrpcMessage) error {
	var err error
...
func (c *Client) BatchCallContext(ctx context.Context, b []BatchElem) error {
	...
	for i, elem := range b {
		msg, err := c.newObjectMessage(elem.Method, elem.Args)
		if err != nil {
			return err
		}
		msgs[i] = msg
...
func (c *Client) Subscribe(ctx context.Context, namespace string, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	...
	msg, err := c.newArrayMessage(namespace+subscribeMethodSuffix, args)
	if err != nil {
		return nil, err
	}
	op := &requestOp{
...
func (c *Client) newArrayMessage(method string, paramsIn ...interface{}) (*jsonrpcMessage, error) {
...
func (c *Client) newObjectMessage(method string, paramsIn interface{}) (*jsonrpcMessage, error) {
	params, err := json.Marshal(paramsIn)
	if err != nil {
		return nil, err
	}
